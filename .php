...
echo'<p style="color: white; text-align: center"><b> Your signup is done!!</b></p>';
$email=$_POST['email'];
$pswd=$_POST['pswd'];
$repswd=$_POST['repswd'];

$EncryptPassword = md5($pswd);
$EncryptRPassword = md5($repswd);
$sql="INSERT INTO `website`.`signup` ( `email`, `pswd`, `repswd`, `date`) VALUES ('$email', '$EncryptPassword', '$EncryptRPassword ', current_timestamp());";
//echo $sql;
  ...
  <li class="nav__item"><a href="FAQ.html" class="nav__link">FAQ</a></li>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Mom's Kitchen</h1>
                        <h2 class="home__subtitle">Try the best homemade food of <br> your choice.</h2>
            ...
            <section class="menu section bd-container" id="menu">
				...
				<h1 style="text-align:center;"> Choose Your Favourite foodtype!!!</h1>
   <h1 style=text-align:center> <a href="veg.html" class="button" data-inline="true">VEG</a>
  
   <h1 style=text-align:center> <a href="nonveg.html" class="button" data-inline="true">NON-VEG</a>	    
...
<body>
	...
	<form action="/action_page.php">
		<div class="imgcontainer">
			<img src="C:\Users\Ajinkya\Desktop\website\assets\img\symbol.jpeg"  class="center" width="300" height="400">
		</div>
		...
		<div class="container" style="background-color:#f1f1f1">
			...
			<!--========== signup ==========-->
			 <section class="login section bd-container" id="signup">
...
<body>
	...
	<form action="signup.php"  method="post"  style="border:1px solid #ccc">
		<div class="container">
			...
			<input type="password" placeholder="Repeat Password" name="repswd" required>
			<input type="checkbox" checked="checked"> Remember me
