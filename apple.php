...
<html lang="en">
  ...
  <li class="nav__item"><a href="index.php" class="nav__link">Chat</a></li>
...
<body>
	...
	<form action="login.php" method="post">
		<div class="imgcontainer">
			<img src="img\symbol.jpeg"  class="center" width="300" height="400">
		</div>
...
<body>
	...
	<form action="signup.php" method="post" style="border:1px solid #ccc">
		<div class="container">
			...
			<input type="checkbox" checked="checked"> Remember me
			<p>To create an account you have to agree our <a href="terms.html">Terms & Privacy</a>.</p>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    ...
                    <div class="contact__button">
                        <a href="index.php" class="button">Contact us now</a>
                    </div>
                </div>
            </section>
        </main>
